...
class PresencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presence" do
    assert_difference('Presence.count') do
      post presences_url, params: { presence: { ccheckout: @presence.ccheckout, checkin: @presence.checkin } }
    end
  ...
  test "should update presence" do
    patch presence_url(@presence), params: { presence: { ccheckout: @presence.ccheckout, checkin: @presence.checkin } }
